...
public class PSColorPanel : MonoBehaviour,IBeginDragHandler, IEndDragHandler, IDragHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        Vector3 localPos = hueRect.worldToLocalMatrix.MultiplyPoint(clickPos);
        // 判定是在色相的环里，还是饱和度的三角形里
        Vector2 dir = new Vector2(localPos.x, localPos.y) - hueRect.rect.center;
    ...
    void SetHueThumbPos(float h)
    {
        ...
        Vector2 pos = new Vector2(dir.x * hueRect.rect.width/2, dir.y*hueRect.rect.height/2);
